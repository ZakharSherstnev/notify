      ...
      <div class="container">
        <div class="notify__wrapper">
          ...
          <div class="notify__content">
            <ThePreloader v-if="loading" :width="90" :height="90" />

            <div class="error" v-if="error">
              <p>{{ error }}</p>
            </div>

            <TheNotify v-if="!loading && !error" :messages="messages" />
          </div>
        </div>
      </div>
    </section>
...
import TheNotify from "../TheNotify.vue";
import ThePreloader from "../UI/ThePreloader.vue";
...
export default {
  ...
  components: { TheNotify, ThePreloader },
};
</script>
